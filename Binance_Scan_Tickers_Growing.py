        ...
        for symbol_to_watch, value_to_watch in array_watch.items():
            if symbol_to_watch == symbol:
                ...
                if ask >= value_to_watch:
                    ...
                    print(array_count[symbol_to_watch], symbol_to_watch, "is greater or equals to", value_to_watch, "increasing value to watch for", symbol, "to", array_watch[symbol_to_watch], str_lien, "evol/t0", "{:.2f}".format(evol_pourcent) + "%")
                    #beep.beep(1)
