#python marina2.py --list-timeframes
#Available timeframes: 1s, 1m, 3m, 5m, 15m, 30m, 1h, 2h, 4h, 6h, 8h, 12h, 1d, 3d, 1w, 1M

#python marina2.py --timeframe 1h
#Scan results at 2024-07-23 14:44:19 (Paris time):
#[2024-07-23 14:44:22] BTC/USDT (BINANCE:BTCUSDT) has a current candlestick that is red in the 1h timeframe.
#[2024-07-23 14:44:22] ETH/USDT (BINANCE:ETHUSDT) has a current candlestick that is red in the 1h timeframe.
#[2024-07-23 14:44:22] NEO/USDT (BINANCE:NEOUSDT) has a current candlestick that is red in the 1h timeframe.
#[2024-07-23 14:44:24] XLM/USDT (BINANCE:XLMUSDT) has a current candlestick that is green in the 1h timeframe.
