...
# Example of use : python Ichimoku2022_Multithreaded_3_TS_KS_SSB.py -e bybit -f *usdt -tf 1h,15m -l -up -down
...
# To activate scanning of assets that are getting above/below their ts/ks/ssb
scan_ts_ks_ssb = True
scan_validated_up_or_down = True
...
def check_timeframe_up(symbol, tf):
    ...
    if scan_ts_ks_ssb:
        ...
        if price_open_chikou < kijun_chikou and price_close_chikou > kijun_chikou:
            str_to_log = "(UPTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "CS getting above its KIJUN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open_chikou < tenkan_chikou and price_close_chikou > tenkan_chikou:
            str_to_log = "(UPTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "CS getting above its TENKAN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open_chikou < ssb_chikou and price_close_chikou > ssb_chikou:
            str_to_log = "(UPTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "CS getting above its SSB in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)

        if price_open1 < kijun1 and price_close1 > kijun1:
            str_to_log = "(UPTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "has got above its KIJUN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open1 < tenkan1 and price_close1 > tenkan1:
            str_to_log = "(UPTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "has got above its TENKAN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open1 < ssb and price_close1 > ssb:
            str_to_log = "(UPTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "has got above its SSB in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
...
def check_timeframe_down(symbol, tf):
    ...
    if scan_ts_ks_ssb:
        ...
        if price_open_chikou > kijun_chikou and price_close_chikou < kijun_chikou:
            str_to_log = "(DOWNTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "CS getting below its KIJUN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open_chikou > tenkan_chikou and price_close_chikou < tenkan_chikou:
            str_to_log = "(DOWNTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "CS getting below its TENKAN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open_chikou > ssb_chikou and price_close_chikou < ssb_chikou:
            str_to_log = "(DOWNTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "CS getting below its SSB in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)

        if price_open1 > kijun1 and price_close1 < kijun1:
            str_to_log = "(DOWNTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "has got below its KIJUN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
        if price_open1 > tenkan1 and price_close1 < tenkan1:
            str_to_log = "(DOWNTREND)" + ";" + str(datetime.now()).split('.')[0] + ";" + symbol + ";" + "has got below its TENKAN in" + ";" + tf + ";" + str(evol)
            print(str_to_log)
            log_to_results(str_to_log)
...
def main_thread():
    ...
    while True:
        for oneline in markets:
            ...
            if condition_ok: # and symbol == 'BTCUSDT':
                try:
