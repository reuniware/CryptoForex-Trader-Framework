...
def execute_code(symbol, type_of_asset, exchange_id):
    ...
    for tf in exchange.timeframes:
        ...
        try:
            ...
            #dev force condition - begin
            tenkan2 = dframe['ICH_TS'].iloc[-2]
            tenkan3 = dframe['ICH_TS'].iloc[-3]
            kijun2 = dframe['ICH_KS'].iloc[-2]
            kijun3 = dframe['ICH_KS'].iloc[-3]
            open2 = dframe['open'].iloc[-2]
            close2 = dframe['close'].iloc[-2]

            #kijun support 1
            #condition = open2 > close2 and price_open < price_close \
                #and open2 > kijun2 and close2 < kijun2 and price_open < kijun and price_close > kijun

            #condition = price_close > price_open and chikou > ssa_chikou and chikou > ssb_chikou and chikou > price_high_chikou and chikou > kijun_chikou and chikou > tenkan_chikou

            condition = dframe['bb_high'].iloc[-2] > kijun2 and dframe['bb_high'].iloc[-1] < kijun
