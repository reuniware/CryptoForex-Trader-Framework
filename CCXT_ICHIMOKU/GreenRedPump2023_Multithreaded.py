# Green or Red candlesticks Scanner for Traders 1.0 (Inelida GreenRed Scanner for Traders)
...
if sys.gettrace() is not None:
    ...
    args.loop = True
    args.timeframes = "1m,3m,5m,15m,30m,1h,2h"
    args.up = True
    args.down = True
...
def check_timeframe_up(symbol, tf):
    ...
    if (price_close - price_open) / price_close * 100 > 0.4:
        return True
