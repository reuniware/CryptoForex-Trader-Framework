...
while True:
    ...
    pastDateAndTime = currentDateAndTime - timedelta(days=365*50)
    ...
    ohlcv = yf.download('EURUSD=X', start=strStartDate, end=strEndDate, interval='1d') # 730 days backward is the maximum range 
    ...
    #ohlcv = yf.download('EURUSD=X', start=strStartDate, end=strEndDate, interval='1m') # 60 days backward is the maximum range
