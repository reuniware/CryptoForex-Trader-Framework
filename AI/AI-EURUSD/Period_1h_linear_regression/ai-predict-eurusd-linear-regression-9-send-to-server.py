...
!rm -rf modeles*
!cp ./drive/MyDrive/modeles_a_trier_eurusd_05062023_0.1855_timestep60.zip ./
!unzip modeles_a_trier_eurusd_05062023_0.1855_timestep60.zip
...
whole_model_folder_to_load = './modeles_a_trier/20230605083407-whole_model'
...
while True:
  ...
  if (current_prediction != previous_prediction) and create_model is False and discord is True:
      ...
      try:
        x = requests.get('https://eurodollarbot.000webhostapp.com/?upload_history=' + str(datetime.now()).split('.')[0] + ";" + "EUR/USD" + ";" + str("{0:.5f}".format(predicted_diff)) + ";" + str(predicted_price))
      except:
