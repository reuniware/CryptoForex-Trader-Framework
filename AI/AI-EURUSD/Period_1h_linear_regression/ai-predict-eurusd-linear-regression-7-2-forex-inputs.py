...
while True:
  ...
  #ohlcv = yf.download('EURUSD=X', start='2021-06-01', end='2023-05-03', interval='15m')
  ohlcv_usd_jpy = yf.download('USDJPY=X', start=strStartDate, end=strEndDate, interval='1h') # 60 days backward is the maximum range
  #ohlcv = yf.download('EURUSD=X', start=strStartDate, end=strEndDate, interval='1h') # 730 days backward is the maximum range
  ...
  data = scaler.fit_transform(combined_data[['Close_eurusd', 'Close_usdjpy']].values)
