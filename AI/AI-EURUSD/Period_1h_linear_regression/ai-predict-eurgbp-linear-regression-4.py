...
ohlcv = yf.download('EURGBP=X', start=strStartDate, end=strEndDate, interval='1h') # 60 days backward is the maximum range
...
if create_model:
  ...
  model.fit(X_train, y_train, epochs=2000, batch_size=None, validation_split=0.1, shuffle=False)
