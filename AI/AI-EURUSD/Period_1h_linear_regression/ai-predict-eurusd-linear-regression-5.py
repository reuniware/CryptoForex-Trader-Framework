...
#!zip -r 'modeles_a_trier_eurusd_01062023_0.17.zip' 'modeles_a_trier'
#!cp './modeles_a_trier_eurusd_01062023_0.17.zip' './drive/MyDrive/'
#!rm -rf modeles*
#!cp ./drive/MyDrive/modeles_a_trier_eurusd_31052023_0.18.zip ./
#!unzip modeles_a_trier_eurusd_31052023_0.18.zip
...
whole_model_folder_to_load = './modeles_a_trier/20230601112503-whole_model'
...
if create_model is False and discord is True:
    webhook.send("**Starting EUR/USD AI with Deep Learning Model [" + os.path.basename(whole_model_folder_to_load) + "]**")
...
while True:
  ...
  if (current_prediction != previous_prediction) and create_model is False and discord is True:
      webhook.send("EUR/USD : Predicted_diff in points (pips) = " + str(round(predicted_diff * 100000)) + " ; Last close = " + "{0:.5f}".format(latest_close_price))
