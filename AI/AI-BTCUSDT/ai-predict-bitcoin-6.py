...
klinesT = Client().get_historical_klines("BTCUSDT", Client.KLINE_INTERVAL_4HOUR, "01 January 2022")
...
model.fit(X_train, y_train, epochs=200, batch_size=16, validation_split=0.1, shuffle=False)
