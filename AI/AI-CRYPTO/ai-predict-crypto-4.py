...
#!zip -r 'modeles_a_trier_btcusdt_04062023_1.4820_timestep60.zip' 'modeles_a_trier'
#!cp './modeles_a_trier_btcusdt_04062023_1.4820_timestep60.zip' './drive/MyDrive/'
!rm -rf modeles*
!cp ./drive/MyDrive/modeles_a_trier_btcusdt_04062023_1.4820_timestep60.zip ./
!unzip modeles_a_trier_btcusdt_04062023_1.4820_timestep60.zip
...
whole_model_folder_to_load = './modeles_a_trier/20230604072443-whole_model'
