...
klinesT = Client().get_historical_klines("BTCUSDT", Client.KLINE_INTERVAL_15MINUTE, "01 January 2023")
...
data = scaler.fit_transform(np.array(bitcoin_data[['open', 'high', 'low', 'close', 'volume']]))
