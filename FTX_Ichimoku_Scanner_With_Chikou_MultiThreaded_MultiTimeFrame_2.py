...
def execute_code(symbol):
    ...
    for indexdf, rowdf in dframe.iterrows():
        ...
        try:
            ...
            openpH1 = dframeH1['open'].iloc[-1]
            openpH4 = dframeH4['open'].iloc[-1]
            openpDaily = dframeDaily['open'].iloc[-1]
            openpWeekly = dframeWeekly['open'].iloc[-1]
            closeH1 = dframeH1['close'].iloc[-1]
            closeH4 = dframeH4['close'].iloc[-1]
            closeDaily = dframeDaily['close'].iloc[-1]
            closeWeekly = dframeWeekly['close'].iloc[-1]
            highH1 = dframeH1['high'].iloc[-1]
            highH4 = dframeH4['high'].iloc[-1]
            highDaily = dframeDaily['high'].iloc[-1]
            highWeekly = dframeWeekly['high'].iloc[-1]
            lowH1 = dframeH1['low'].iloc[-1]
            lowH4 = dframeH4['low'].iloc[-1]
            lowDaily = dframeDaily['low'].iloc[-1]
            lowWeekly = dframeWeekly['low'].iloc[-1]
            openchikouH1 = dframeH1['open'].iloc[-26]
            openchikouH4 = dframeH4['open'].iloc[-26]
            openchikouDaily = dframeDaily['open'].iloc[-26]
            openchikouWeekly = dframeWeekly['open'].iloc[-26]
            closechikouH1 = dframeH1['close'].iloc[-26]
            closechikouH4 = dframeH4['close'].iloc[-26]
            closechikouDaily = dframeDaily['close'].iloc[-26]
            closechikouWeekly = dframeWeekly['close'].iloc[-26]
            highchikouH1 = dframeH1['high'].iloc[-26]
            highchikouH4 = dframeH4['high'].iloc[-26]
            highchikouDaily = dframeDaily['high'].iloc[-26]
            highchikouWeekly = dframeWeekly['high'].iloc[-26]
            lowchikouH1 = dframeH1['low'].iloc[-26]
            lowchikouH4 = dframeH4['low'].iloc[-26]
